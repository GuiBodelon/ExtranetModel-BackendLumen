...
class CreateApiTnummMedicamentosTmp extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('api_tnumm_medicamentos_tmp', function (Blueprint $table) {
            $table->increments('id');
            $table->string('codigo');
    ...
    {
        Schema::dropIfExists('api_tnumm_medicamentos_tmp');
    }
}
