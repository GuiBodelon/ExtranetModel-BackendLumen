...
class GovernancaController extends BaseController
{
     ...
     */
     ...
     public function getFormulas(Request $request)
     {
        ...
        $formulas = DB::connection('oracle_smartadm')->setDateFormat('DD/MM/YYYY')->select("SELECT FORMULA_SIGLA, LTRIM(TO_CHAR(VALOR, '99999999999999999990.999')) VALOR, MESREF, FORMULA_FK FROM API_INDICADORES_RN443 WHERE REPLACE(MESREF, '/', '') = '$mesref'");
