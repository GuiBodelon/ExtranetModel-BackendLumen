...
class EventosPagosController extends BaseController
{
	...
	public function totalizadorEventosPagos(Request $request){
				...
				$totalPagamentoInternacoes = array_column($selectEventosPagos, 'valor_pagamento');
				$totalRecuperadoInternacoes = array_column($selectEventosPagos, 'valor_recuperacao');
				$totalEventoInternacoes = array_column($selectEventosPagos, 'valor_evento');
				$totalGlosaInternacoes = array_column($selectEventosPagos, 'vlr_glosa');
				...
				$selectEventosPagos = DB::connection('oracle_spasaude')
				->select("SELECT TIPO_EVENTO_ANS, VALOR_PAGAMENTO, VALOR_EVENTO, VALOR_RECUPERACAO, VLR_GLOSA FROM API_REG_AUX_EVENTOS_PAGOS  WHERE TIPO_EVENTO_ANS = 'Terapias' AND FK_REGISTROS_AUX_LOTE = $lote_fk");

				$tipoEvento = 'Terapias';
				$totalPagamentoTerapias = array_column($selectEventosPagos, 'valor_pagamento');
				$totalRecuperadoTerapias = array_column($selectEventosPagos, 'valor_recuperacao');
				$totalEventoTerapias = array_column($selectEventosPagos, 'valor_evento');
				$totalGlosaTerapias = array_column($selectEventosPagos, 'vlr_glosa');
				...
				$selectEventosPagos = DB::connection('oracle_spasaude')
				->select("SELECT TIPO_EVENTO_ANS, VALOR_PAGAMENTO, VALOR_EVENTO, VALOR_RECUPERACAO, VLR_GLOSA FROM API_REG_AUX_EVENTOS_PAGOS  WHERE TIPO_EVENTO_ANS = 'Pacotes' AND FK_REGISTROS_AUX_LOTE = $lote_fk");

				$tipoEvento = 'Pacotes';
				$totalPagamentoPacotes = array_column($selectEventosPagos, 'valor_pagamento');
				$totalRecuperadoPacotes = array_column($selectEventosPagos, 'valor_recuperacao');
				$totalEventoPacotes = array_column($selectEventosPagos, 'valor_evento');
				$totalGlosaPacotes = array_column($selectEventosPagos, 'vlr_glosa');
				...
				$selectEventosPagos = DB::connection('oracle_spasaude')
				->select("SELECT TIPO_EVENTO_ANS, VALOR_PAGAMENTO, VALOR_EVENTO, VALOR_RECUPERACAO, VLR_GLOSA FROM API_REG_AUX_EVENTOS_PAGOS  WHERE TIPO_EVENTO_ANS = 'Consultas médicas' AND FK_REGISTROS_AUX_LOTE = $lote_fk");

				$tipoEvento = 'Consultas médicas';
				$totalPagamentoConsultasMedicas = array_column($selectEventosPagos, 'valor_pagamento');
				$totalRecuperadoConsultasMedicas = array_column($selectEventosPagos, 'valor_recuperacao');
				$totalEventoConsultasMedicas = array_column($selectEventosPagos, 'valor_evento');
				$totalGlosaConsultasMedicas = array_column($selectEventosPagos, 'vlr_glosa');
				...
				// Totalizadores Exames Compementares
				$selectEventosPagos = DB::connection('oracle_spasaude')
				->select("SELECT TIPO_EVENTO_ANS, VALOR_PAGAMENTO, VALOR_EVENTO, VALOR_RECUPERACAO, VLR_GLOSA FROM API_REG_AUX_EVENTOS_PAGOS  WHERE TIPO_EVENTO_ANS = 'Exames complementares' AND FK_REGISTROS_AUX_LOTE = $lote_fk");

				$tipoEvento = 'Exames complementares';
				$totalPagamentoExamesComplementares = array_column($selectEventosPagos, 'valor_pagamento');
				$totalRecuperadoExamesComplementares = array_column($selectEventosPagos, 'valor_recuperacao');
				$totalEventoExamesComplementares = array_column($selectEventosPagos, 'valor_evento');
				$totalGlosaExamesComplementares = array_column($selectEventosPagos, 'vlr_glosa');
				...
				$selectEventosPagos = DB::connection('oracle_spasaude')
				->select("SELECT TIPO_EVENTO_ANS, VALOR_PAGAMENTO, VALOR_EVENTO, VALOR_RECUPERACAO, VLR_GLOSA FROM API_REG_AUX_EVENTOS_PAGOS  WHERE TIPO_EVENTO_ANS = 'Outros atendimentos ambulatoriais' AND FK_REGISTROS_AUX_LOTE = $lote_fk");

				$tipoEvento = 'Outros atendimentos ambulatoriais';
				$totalPagamentoOutrosAtendimentos = array_column($selectEventosPagos, 'valor_pagamento');
				$totalRecuperadoOutrosAtendimentos = array_column($selectEventosPagos, 'valor_recuperacao');
				$totalEventoOutrosAtendimentos = array_column($selectEventosPagos, 'valor_evento');
				$totalGlosaOutrosAtendimentos = array_column($selectEventosPagos, 'vlr_glosa');
				...
				$selectEventosPagos = DB::connection('oracle_spasaude')
				->select("SELECT TIPO_EVENTO_ANS, VALOR_PAGAMENTO, VALOR_EVENTO, VALOR_RECUPERACAO, VLR_GLOSA FROM API_REG_AUX_EVENTOS_PAGOS  WHERE TIPO_EVENTO_ANS = 'Demais despesas assistenciais' AND FK_REGISTROS_AUX_LOTE = $lote_fk");
				
				$tipoEvento = 'Demais despesas assistenciais';
				$totalPagamentoDemaisDespesas = array_column($selectEventosPagos, 'valor_pagamento');
				$totalRecuperadoDemaisDespesas = array_column($selectEventosPagos, 'valor_recuperacao');
				$totalEventoDemaisDespesas = array_column($selectEventosPagos, 'valor_evento');
				$totalGlosaDemaisDespesas = array_column($selectEventosPagos, 'vlr_glosa');
